...
# tab 1 ####
                                     conditionalPanel("input.tabs == 1",
                                                      ...
                                                      conditionalPanel("input.occSel == 'GBIF'",
                                                                       ...
                                                                       HTML('<hr>'),
                                                                       textInput("gbifName", label = "Enter scientific name of species (format: genus species)", value = 'Cryptotis mexicana'),
                                                                       actionButton("goName", "Search GBIF"),
                                                                       br(), br(),
                                                                       sliderInput("gbifNum", "Maximum number of occurrences:", min = 1, max = 500, value = 50),
                                                                       #br(),
                                                                       #uiOutput('gbifDnld'),
...
# tab 8 ####
                                     conditionalPanel("input.tabs == 8",
                                                      ...
                                                      conditionalPanel("input.projSel == 'pjArea'",
                                                                       div('Module: Project to New Area', id="mod")),
                                                      ...
                                                      HTML('<hr>'),
                                                      conditionalPanel("input.projSel == 'pjArea'",
                                                                       strong("Project to new area (current extent)"), br(), br(),
...
column(8,
       ...
       conditionalPanel("input.tabs == 7 && input.visSel == 'bcEnvel' && input.enmSel == 'BIOCLIM'", imageOutput('bcEnvelPlot')),
       conditionalPanel("input.tabs == 7 && input.visSel == 'mxEval'  && input.enmSel == 'Maxent'", imageOutput('mxEvalPlot')),
