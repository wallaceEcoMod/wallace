                                                      ...
                                                      conditionalPanel("input.visSel == 'map'",
                                                                       ...
                                                                       selectInput('predThresh', label = "Set threshold",
                                                                                   choices = list("No threshold" = 'noThresh',
                                                                                                  "MTP" = 'mtp', "10%" = 'p10'),
                                                                                   selected = ''),
                                                                       bsPopover('predThresh', title = 'Tip',
