...
### run function
out.gbif <- occs_queryDb(spName, occDb, occNum)
...
test_that("warnings checks", {
  ...
  expect_warning(queryDb(spName = "Artibeus macleayii", occDb, occNum),
