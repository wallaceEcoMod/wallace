...
sinkRmdTitle <- function(title = "Code description") {
  ...
  cat("\n---")
  cat("\n\n## About")
  cat("\n\nThis is an R Markdown document in which all decisions made by the users are registered. With this document users can track their own analysis and recreate it in R itself.")
