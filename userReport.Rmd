...
part <- input$goPart != 0
isBlock <- if (input$partSelect2 != "") input$partSelect2 == 'block' else FALSE
isCB1 <- if (input$partSelect2 != "") input$partSelect2 == 'cb1' else FALSE
isCB2 <- if (input$partSelect2 != "") input$partSelect2 == 'cb2' else FALSE
isJack <- if (input$partSelect2 != "") input$partSelect2 == 'jack' else FALSE
isRandom <- if (input$partSelect2 != "") input$partSelect2 == 'random' else FALSE
model <- input$goEval != 0
isBC <- if (!is.null(values$evalMods)) input$modSelect == 'BIOCLIM' else FALSE
isMX <- if (!is.null(values$evalMods)) input$modSelect == 'Maxent' else FALSE
```
