...
part <- input$goPart != 0
isBlock <- if (input$partSel2 != "") input$partSel2 == 'block' else FALSE
isCB1 <- if (input$partSel2 != "") input$partSel2 == 'cb1' else FALSE
isCB2 <- if (input$partSel2 != "") input$partSel2 == 'cb2' else FALSE
isJack <- if (input$partSel2 != "") input$partSel2 == 'jack' else FALSE
isRandom <- if (input$partSel2 != "") input$partSel2 == 'random' else FALSE
model <- input$goEval != 0
isBC <- if (!is.null(values$evalMods)) input$modSel == 'BIOCLIM' else FALSE
isMX <- if (!is.null(values$evalMods)) input$modSel == 'Maxent' else FALSE
```
