...
isBB <- input$backgSelect == 'bb'
isMCP <- input$backgSelect == 'mcp'
isUserBG <- input$backgSelect == 'user'
part <- input$goPart != 0
isBlock <- input$partSelect2 == 'block'
isCB1 <- input$partSelect2 == 'cb1'
isCB2 <- input$partSelect2 == 'cb2'
isJack <- input$partSelect2 == 'jack'
isRandom <- input$partSelect2 == 'random'
model <- input$goEval != 0
isBC <- input$modSelect == 'BIOCLIM'
isMX <- input$modSelect == 'Maxent'
```
