...
base_module_configs <- c(
  ...
  "modules/indic_range.yml",
  "modules/indic_overlap.yml",
  "modules/indic_time.yml",
  "modules/diver_richness.yml",
  "modules/diver_endemism.yml",
