...
Please find below the R code history from your *Wallace* v1.0.6.3 session. 
...
e <- ENMeval::ENMevaluate(occ = occs.xy, env = envsBgMsk, bg.coords = bg.xy, RMvalues = rms, fc = {{fcs}}, 
