...
*Wallace* (v.WxC) currently includes ten components, or steps of a possible workflow. Each component includes two or more modules, which are possible analyses for that step.  
