...
<<<<<<< HEAD
Welcome to *Wallace*, a flexible application for reproducible ecological modeling, built for community expansion. The current version of *Wallace* (v1.0.5.9*) steps the user through a full niche/distribution modeling analysis, from data acquisition to visualizing results.
=======
Welcome to *Wallace*, a flexible application for reproducible ecological modeling, built for community expansion. The current version of *Wallace* (v1.0.5.9100) steps the user through a full niche/distribution modeling analysis, from data acquisition to visualizing results.
