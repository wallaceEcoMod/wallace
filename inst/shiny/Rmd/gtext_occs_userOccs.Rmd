...
Users may upload a .csv file of occurrence records with rows of localities, and the first three fields must be named "scientific_name" (the scientific species name, which must be the same for all rows), "longitude", and "latitude" (in that order, with those names). Other fields can appear after these mandatory fields, but they are not used in the analysis.
