c2_removeByID_module_ui <- function(id) {
  ns <- shiny::NS(id)
  tagList(
...
c2_removeByID_module_server <- function(input, output, session, common) {
...
c2_removeByID_module_map <- function(map, common) {
  occs <- common$occs
  # Map logic
...
c2_removeByID_module_rmd <- function(species) {
