...
mapProjVals_{{spAbr}} <- alfred.getRasterVals(proj_userEnvs_{{spAbr}}$projUser, "{{outputType_rmd}}")
...
bbZoom <- polyZoom(bb_{{spAbr}}[1, 1], bb_{{spAbr}}[2, 1], bb_{{spAbr}}[1, 2], 
                   bb_{{spAbr}}[2, 2], fraction = 0.05)
mapProjVals_{{spAbr}} <- alfred.getRasterVals(proj_userEnvs_{{spAbr}},"{{outputType_rmd}}")
