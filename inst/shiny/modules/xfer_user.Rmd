...
mapXferVals_{{spAbr}} <- alfred.getRasterVals(xfer_userEnvs_{{spAbr}}$xferUser, "{{outputType_rmd}}")
...
bbZoom <- polyZoom(bb_{{spAbr}}[1, 1], bb_{{spAbr}}[2, 1], bb_{{spAbr}}[1, 2], 
                   bb_{{spAbr}}[2, 2], fraction = 0.05)
mapXferVals_{{spAbr}} <- alfred.getRasterVals(xfer_userEnvs_{{spAbr}},"{{outputType_rmd}}")
