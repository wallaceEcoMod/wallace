...
Merow, C.,  Maitner, B., Owens, H., Kass, J., Enquist, B., Guralnik, R.,  Zurrell, D., Koenig, C. (2021).rangeModelMetadata: Provides Templates for Metadata Files Associated with Species Range Models. R package v1.0.4. <a href="https://CRAN.R-project.org/package=rangeModelMetadata" target="_blank">https://CRAN.R-project.org/package=rangeModelMetadata</a> 
