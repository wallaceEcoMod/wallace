c2_selectOccs_module_ui <- function(id) {
  ns <- shiny::NS(id)
  tagList(
...
c2_selectOccs_module_server <- function(input, output, session, common) {
...
c2_selectOccs_module_map <- function(map, common) {
  occs <- common$occs
  # Map logic
  map %>% clearAll() %>%
...
c2_selectOccs_module_rmd <- function(species) {
