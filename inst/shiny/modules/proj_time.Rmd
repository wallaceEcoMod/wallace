...
### Project model
Projecting the model to the same modelling area with no threshold rule. New time based on "{{envs_name_rmd}}" variables for {{yearMin_rmd}} using a "{{model_rmd}}" GCM and an RCP of  *`r {{rcp_rmd}}/10`*.
```
...
projTimeEnvs_{{spAbr}} <- raster::getData(
  'CMIP5',
  var = "bio",
  res = as.integer((raster::res(bgMask_{{spAbr}}) * 60)[1]),
  rcp = {{rcp_rmd}},
  model = "{{model_rmd}}",
  year = {{year_rmd}})
...
projExt_{{spAbr}} <- proj_time_{{spAbr}}$projExt
...
mapProjVals_{{spAbr}} <- alfred.getRasterVals(proj_time_{{spAbr}}$projTime,"{{outputType_rmd}}")
...
# map model prediction raster and projection polygon
  ...
  addRasterImage(proj_time_{{spAbr}}$projTime, colors = rasPal_{{spAbr}}, opacity = 0.7,
...
```{asis, echo = {{proj_time_knit & !proj_time_user_knit & !proj_time_drawn_knit &  proj_time_threshold_knit &  proj_time_worldclim_knit}}, eval = {{proj_time_knit & !proj_time_user_knit & !proj_time_drawn_knit &  proj_time_threshold_knit & proj_time_worldclim_knit}}, include = {{proj_time_knit & !proj_time_user_knit & !proj_time_drawn_knit &  proj_time_threshold_knit &    proj_time_worldclim_knit}}}
### Project model
Projecting the model to the same modelling area with a "{{proj_thresholdRule_rmd}}" threshold rule of {{proj_threshold_rmd}}. New time based on "{{envs_name_rmd}}" variables for {{yearMin_rmd}} using a "{{model_rmd}}" GCM and an RCP of *`r {{rcp_rmd}}/10`*.
```
...
proj_time_{{spAbr}} <- proj_time_{{spAbr}}$projTime > proj_thresProb_{{spAbr}}
...
bbZoom <- alfred.polyZoom(bb_{{spAbr}}[1, 1], bb_{{spAbr}}[2, 1], bb_{{spAbr}}[1, 2], 
                   bb_{{spAbr}}[2, 2], fraction = 0.05)
mapProjVals_{{spAbr}} <- alfred.getRasterVals(proj_time_{{spAbr}},"{{outputType_rmd}}")
...
# map model prediction raster and projection polygon
  clearMarkers() %>% clearShapes() %>% removeImage('projRas') %>%
  addRasterImage(proj_time_{{spAbr}}, colors = rasPal_{{spAbr}}, opacity = 0.7,
                 layerId = 'projRas', group = 'proj', method = "ngb") %>%
 ##add projection polygon (same modeling area)
  addPolygons(data = bgExt_{{spAbr}}, fill = FALSE,
              weight = 4, color = "blue", group = 'proj')
...
```{asis, echo = {{proj_time_knit & !proj_time_user_knit & proj_time_drawn_knit &  !proj_time_threshold_knit & proj_time_worldclim_knit}}, eval = {{proj_time_knit & !proj_time_user_knit & proj_time_drawn_knit &  !proj_time_threshold_knit & proj_time_worldclim_knit}}, include = {{proj_time_knit & !proj_time_user_knit & proj_time_drawn_knit & !proj_time_threshold_knit & proj_time_worldclim_knit}}}
### Project model
Projecting the model to a user drawn area with no threshold. New time based on "{{envs_name_rmd}}" variables for {{yearMin_rmd}} using a "{{model_rmd}}" GCM and an RCP of *`r {{rcp_rmd}}/10`*.
```
...
```{asis, echo = {{proj_time_knit & !proj_time_user_knit & proj_time_drawn_knit &  proj_time_threshold_knit & proj_time_worldclim_knit}}, eval = {{proj_time_knit & !proj_time_user_knit & proj_time_drawn_knit &  proj_time_threshold_knit & proj_time_worldclim_knit}}, include = {{proj_time_knit & !proj_time_user_knit & proj_time_drawn_knit & proj_time_threshold_knit & proj_time_worldclim_knit}}}
### Project model
Projecting the model to a user drawn area with a "{{proj_thresholdRule_rmd}}" threshold rule of {{proj_threshold_rmd}}. New time based on "{{envs_name_rmd}}" variables for {{yearMin_rmd}} using a "{{model_rmd}}" GCM and an RCP of *`r {{rcp_rmd}}/10`*.
```
...
```{asis, echo = {{proj_time_knit & proj_time_user_knit & !proj_time_drawn_knit &  !proj_time_threshold_knit & proj_time_worldclim_knit}}, eval = {{proj_time_knit & proj_time_user_knit & !proj_time_drawn_knit &  !proj_time_threshold_knit & proj_time_worldclim_knit}}, include = {{proj_time_knit & proj_time_user_knit & !proj_time_drawn_knit & !proj_time_threshold_knit & proj_time_worldclim_knit}}}
### Project model
Projecting the model to a user provided area area with no threshold. New time based on "{{envs_name_rmd}}" variables for {{yearMin_rmd}} using a "{{model_rmd}}" GCM and an RCP of *`r {{rcp_rmd}}/10`*.
```
...
rasCols_{{spAbr}} <- c("#2c7bb6", "#abd9e9", "#ffffbf", "#fdae61", "#d7191c")
# if no threshold specified
legendPal <- colorNumeric(rev(rasCols_{{spAbr}}), mapProjVals_{{spAbr}}, 
                          na.color = 'transparent')
rasPal_{{spAbr}} <- colorNumeric(rasCols_{{spAbr}}, mapProjVals_{{spAbr}}, 
                                 na.color = 'transparent')
m <- leaflet() %>% addProviderTiles(providers$Esri.WorldTopoMap) 
m %>%
  fitBounds(bbZoom[1], bbZoom[2], bbZoom[3], bbZoom[4]) %>%
...
```{asis, echo = {{proj_time_knit & proj_time_user_knit & !proj_time_drawn_knit &  proj_time_threshold_knit & proj_time_worldclim_knit}}, eval = {{proj_time_knit & proj_time_user_knit & !proj_time_drawn_knit &  proj_time_threshold_knit & proj_time_worldclim_knit}}, include = {{proj_time_knit & proj_time_user_knit & !proj_time_drawn_knit & proj_time_threshold_knit & proj_time_worldclim_knit}}}
### Project model
Projecting the model to a user provided area with a "{{proj_thresholdRule_rmd}}" threshold rule of {{proj_threshold_rmd}}. New time based on "{{envs_name_rmd}}" variables for {{yearMin_rmd}} using a "{{model_rmd}}" GCM and an RCP of *`r {{rcp_rmd}}/10`*.
```
...
```{asis, echo = {{proj_time_knit & !proj_time_user_knit & !proj_time_drawn_knit &  proj_time_threshold_knit &  !proj_time_worldclim_knit}}, eval = {{proj_time_knit & !proj_time_user_knit & !proj_time_drawn_knit &  proj_time_threshold_knit & !proj_time_worldclim_knit}}, include = {{proj_time_knit & !proj_time_user_knit & !proj_time_drawn_knit &  proj_time_threshold_knit &    !proj_time_worldclim_knit}}}
### Project model
Projecting the model to the same modelling area with a "{{proj_thresholdRule_rmd}}" threshold rule of {{proj_threshold_rmd}}. New time based on "{{envs_name_rmd}}" variables for {{yearMin_rmd}} to {{yearMax_rmd}} using a "{{pjAOGCM_rmd}}" GCM and a "{{pjScenario_rmd}}" scenario.
```
...
```{asis, echo = {{proj_time_knit & !proj_time_user_knit & proj_time_drawn_knit &  proj_time_threshold_knit & !proj_time_worldclim_knit}}, eval = {{proj_time_knit & !proj_time_user_knit & proj_time_drawn_knit &  proj_time_threshold_knit & !proj_time_worldclim_knit}}, include = {{proj_time_knit & !proj_time_user_knit & proj_time_drawn_knit & proj_time_threshold_knit & !proj_time_worldclim_knit}}}
### Project model
Projecting the model to a user drawn area with a "{{proj_thresholdRule_rmd}}" threshold rule of {{proj_threshold_rmd}}. New time based on "{{envs_name_rmd}}" variables for {{yearMin_rmd}} to {{yearMax_rmd}} using a "{{pjAOGCM_rmd}}" GCM and a "{{pjScenario_rmd}}" scenario.
...
```{asis, echo = {{proj_time_knit & proj_time_user_knit & !proj_time_drawn_knit &  proj_time_threshold_knit & !proj_time_worldclim_knit}}, eval = {{proj_time_knit & proj_time_user_knit & !proj_time_drawn_knit &  proj_time_threshold_knit & !proj_time_worldclim_knit}}, include = {{proj_time_knit & proj_time_user_knit & !proj_time_drawn_knit & proj_time_threshold_knit & !proj_time_worldclim_knit}}}
### Project model
Projecting the model to a user provided area with a "{{proj_thresholdRule_rmd}}" threshold rule of {{proj_threshold_rmd}}. New time based on "{{envs_name_rmd}}" variables for {{yearMin_rmd}} to {{yearMax_rmd}} using a "{{pjAOGCM_rmd}}" GCM and a "{{pjScenario_rmd}}" scenario.
```
