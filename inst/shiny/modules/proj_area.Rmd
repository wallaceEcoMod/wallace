...
mapXferVals_{{spAbr}} <- alfred.getRasterVals(xfer_area_{{spAbr}}$xferArea,"{{outputType_rmd}}")
...
bbZoom <- alfred.polyZoom(bb_{{spAbr}}[1, 1], bb_{{spAbr}}[2, 1], bb_{{spAbr}}[1, 2], 
                   bb_{{spAbr}}[2, 2], fraction = 0.05)
mapXferVals_{{spAbr}} <- alfred.getRasterVals(xfer_area_{{spAbr}},"{{outputType_rmd}}")
