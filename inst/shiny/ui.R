             ...
             fluidRow(column(4,
                             wellPanel(
                               ...
                               conditionalPanel("input.tabs == 'vis'", 
                                                ...
                                                HTML('<hr>'),
                                                conditionalPanel("input.visSel == 'bcPlot'", uiBottom2(bcPlot_INFO)),
                                                conditionalPanel("input.visSel == 'mxEval'", uiBottom2(mxEvalPlots_INFO)),
                                                conditionalPanel("input.visSel == 'response'", uiBottom2(respPlots_INFO)),
                                                conditionalPanel("input.visSel == 'map'", 
                             ...
                             conditionalPanel("input.tabs != 'rmd' & input.tabs != 'intro'",
                                              tabsetPanel(id = 'main',
                                                          ...
                                                          tabPanel('Results', 
                                                                   ...
                                                                   conditionalPanel("input.tabs == 'vis' && input.visSel == 'bcPlots' && input.modelSel == 'BIOCLIM'",
                                                                                    imageOutput('bcEnvelPlot')),
                                                                   conditionalPanel("input.tabs == 'vis' && input.visSel == 'mxEval'  && input.modelSel == 'Maxent'",
