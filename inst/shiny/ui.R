                             ...
                             wellPanel(
                               ...
                               conditionalPanel("input.tabs == 6",
                                                ...
                                                radioButtons("enmSel", "Modules Available:",
                                                             choices = list("BIOCLIM", "Maxnet", "Maxent")),
                                                HTML('<hr>'),
                                                ...
                                                conditionalPanel("input.enmSel == 'Maxnet'",
                                                                 div('Module: Maxnet', id="mod"),
                                                                 uiTop('ENMeval', 'Automated Runs and Evaluations of Ecological Niche Models using maxnet package'),
                                                                 uiTop('dismo', 'Species Distribution Modeling'),
