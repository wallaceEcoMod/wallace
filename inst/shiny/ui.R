                             ...
                             wellPanel(
                               ...
                               conditionalPanel("input.tabs == 'vis'", 
                                                ...
                                                conditionalPanel("input.visSel == 'map'",
                                                                 ...
                                                                 uiTop('dismo', 'Species Distribution Modeling'),
                                                                 HTML('<hr>'),
                                                                 conditionalPanel("input.modSel == 'Maxent'", mapPredsMaxent_UI('c7_mapPredsMaxent')), 
                                                                 conditionalPanel("input.modSel != 'Maxent'", mapPreds_UI('c7_mapPreds')),
                             ...
                             conditionalPanel("input.tabs != 'rmd' & input.tabs != 'intro'",
                                              tabsetPanel(id = 'main',
                                                          ...
                                                          tabPanel('Results', 
                                                                   ...
                                                                   conditionalPanel("input.tabs == 'vis' && input.visSel == 'bcPlots' && input.modSel == 'BIOCLIM'",
                                                                                    imageOutput('bcEnvelPlot')),
                                                                   conditionalPanel("input.tabs == 'vis' && input.visSel == 'mxEval'  && input.modSel == 'Maxent'",
