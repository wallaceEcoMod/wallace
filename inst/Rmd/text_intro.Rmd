...
Welcome to *Wallace*, a flexible application for reproducible ecological modeling, built for community expansion. The current version of *Wallace* (ver. 1.0.2; <a href="https://wallaceecomod.github.io/" target="_blank">website</a> steps the user through a full niche/distribution modeling analysis, from data acquisition to visualizing results.
