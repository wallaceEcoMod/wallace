...
pred <- dismo::predict(mod, predsBgMsk, args=c("outputformat=logistic"))
```

```{r, echo = viz.pred.cll, include = viz.pred.cll}
# generate cloglog prediction
pred <- dismo::predict(mod, predsBgMsk, args=c("outputformat=cloglog"))
```
...
proj <- dismo::predict(modSel, predsProj)
```
