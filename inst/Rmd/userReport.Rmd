...
occVals <- raster::extract(e@predictions.raw, modParams$occ.pts)  # get predicted values for occ grid cells
...
```{r, echo = mess, eval = mess, include = mess}
occVals <- raster::extract(predsMsk, occs.locs)
