...
# provide the path to the folder that contains the rasters
# NOTE: no other files but the rasters should be present
d <- ''
d.files <- list.files(full.names = TRUE)
envs <- raster::stack(d.files)
```
