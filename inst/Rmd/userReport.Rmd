...
viz.pred.noThresh <- !(viz.pred.mtp | viz.pred.p10)
# comp8
...
mtp <- thresh(occVals, 'mtp')  
# define 10% training presence threshold
p10 <- thresh(occVals, 'p10')
```
...
evalPredsLog <- stack(sapply(e@models, function(x) predict(x, predsBgMsk)))
