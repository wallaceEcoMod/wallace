...
```{r, eval = F}
wallace::create_module(id = "correlations", dir = "./inst/shiny/modules", map = F, result = T, rmd = F, save = F)
```

### Edit the four new files created in the ./modules directory
Four new files will be created in the ./modules directory: correlations.yml, correlations.md, correlations.Rmd, correlations.R.
