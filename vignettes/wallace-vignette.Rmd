...
This vignette walks the user through the process of building a new module. Researchers who want to share their techniques with the user community can build a module and submit it via a pull request on Github. 
