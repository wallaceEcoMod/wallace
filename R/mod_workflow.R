...
# occs <- occs_queryDb("meles meles", "gbif", 100, doCitations = FALSE)
# sp="Meles_meles"
# envs <- envs_worldclim(10, 1:19)
# occs.thin <- poccs_profileOccs(sp.name = sp,
...
#
#   shinyLogs %>% writeLog(
#     em(spName(curSp())), ": Removing dirty occurrences")
#
#   ########
#
#   # LOAD INTO SPP ####
...
# }
#
# #occs.thin <- poccs_thinOccs(as.data.frame(occs$cleaned), 100)
