...
#' Type: \tab Package\cr
#' Version: \tab 1.0.5.9*\cr
#' Date: \tab 2018-10-08\cr
#' License: \tab GNU 3.0\cr
#' }
#'
#' @references Kass J.M., Pinilla-Buitrago, G.E., Vilela B., Aeillo-Lammens M.E., Muscarella R., Merow C., and Anderson R.P. (2018) \emph{Wallace}: A modular platform for reproducible ecological modeling. Version 1.0.5.9*
