...
#' }
#'
#' @references Kass J.M., Pinilla-Buitrago G.E., Vilela B., Aeillo-Lammens M.E., Muscarella R., Merow C., and Anderson R.P. (2021) \emph{Wallace}: A modular platform for reproducible ecological modeling. Version 1.1.1
