...
#' @details
#' This function is called by the component espace to calibrate a pca for one or 2 species envrionmental space.
...
#' @param bgPts.z2 table of background points with environmental values for sp1.
